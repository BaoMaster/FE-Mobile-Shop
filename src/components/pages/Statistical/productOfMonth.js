...
// function DemoLine() {
class ProductMonth extends Component {
  constructor(props) {
    super(props);
    this.state = {
      dataChart: [],
          ...
          extra={
            <>
              <div style={{ marginRight: '830px', fontSize: '20px' }}>
                <span style={{ marginRight: '20px' }}>Best selling products of the month</span>
                <DatePicker
                  picker='month'
...
export default connect(null, mapDispatchToProps)(withRouter(ProductMonth));
